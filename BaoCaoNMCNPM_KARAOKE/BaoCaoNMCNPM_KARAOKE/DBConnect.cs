...
namespace BaoCaoNMCNPM_KARAOKE
{
    class DBConnect
    {
        public static string sqlcon = @"Data Source=DESKTOP-BH4JOH6;Initial Catalog=QL_KARAOKE;Integrated Security= True";
        ...
        public static void Themdangky(string select, String tk, String pass, String sql1)
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        form_DangNhap dt = new form_DangNhap();
                        dt.Show();
                        fm_taiKhoan a = new fm_taiKhoan();
                        a.Close();
                    }
                    mycon.Close();
                }
